...
@section('header.content')
    <h2 class="text-center mt-3">Data PPDB SMP Dharma Karya</h2>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>{{ DB::table('users')->where('no_registrasi', 'like', '003%')->where('is_data_verified', '=', '2')->count() }}
                                </h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <h3>{{ DB::table('users')->where('no_registrasi', 'like', '003%')->where('is_data_verified', '=', '3')->count() }}
                                </h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-blue">
                            <div class="inner">
                                <h3>{{ DB::table('billings')->where('no_registrasi', 'like', '003%')->where('status_bayar', '=', '1')->count() }}
                                </h3>

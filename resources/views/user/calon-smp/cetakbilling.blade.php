            ...
            <div class="card-body">
                <div class="card-title mb-3">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">: {{ $user->csSmpnama_pd}}</div>
                    </div> 
                    <hr>
                </div>
                <div class="card-text">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-3 border p-3">: {{ $user->billing->no_registrasi }}</div>
                        
                        <div class="col-sm-4 col-md-3 border p-3">Nomor Billing</div>
                        <div class="col-sm-8 col-md-3 border p-3">: {{ $user->billing->billing->no_billing }}</div>

                        <div class="col-sm-4 col-md-3 border p-3">Batas Tanggal Pembayaran</div>
                        <div class="col-sm-8 col-md-3 border p-3">: {{ $user->billing->user_date_create }}</div>
                        
                        <div class="col-sm-4 col-md-3 border p-3">Tanggal Pembayaran</div>
                        <div class="col-sm-8 col-md-3 border p-3">: {{ $user->billing->billing->tanggal_bayar }}</div>
                    </div>
                </div>
            </div>

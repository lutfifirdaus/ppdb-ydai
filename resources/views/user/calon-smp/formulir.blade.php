                    ...
                    <form action="/calon/smp/store/{{ $user->id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 ml-3"><b><h4>Sekolah Asal</h4></b>
                            ...
                            <div class="form-group row ml-3">
                                ...
                                :<textarea rows="3" name="alamat_asal_sekolah" id="alamat_asal_sekolah" class="form-control col-sm-8" value="{{ old('alamat_asal_sekolah') }}"></textarea>
                                @error('alamat_asal_sekolah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="mb-3 ml-3"><b><h4>Ijazah SD/MI/Paket A</h4></b>
                            <div class="form-group row ml-3">
                        ...
                        <div class="mb-3 ml-3"><b><h4>SKHUN SD/MI/Paket A</h4></b>
                            <div class="form-group row ml-3">
                        ...
                        <div class="mb-3 ml-3"><b><h4>UN SD/MI/Paket A</h4></b>
                            <div class="form-group row ml-3">
            ...
            @else
                <div class="card-body mt-3">
                    ...
                    <form action="/calon/smp/update/{{ $user->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        @foreach ($calon_siswa_smps as $calon_siswa_smp)
                        <div class="mb-3 ml-3"><b><h4>Biodata</h4></b>
                            <div class="form-group row ml-3">
                                <label for="nisn" class="col-sm-3 col-form-label">NISN</label>
                                :<input type="number" name="nisn" id="nisn" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nisn }}">
                                @error('nisn')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="nama_pd" class="col-sm-3 col-form-label">Nama Lengkap</label>
                                    :<input type="text" name="nama_pd" id="nama_pd" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nama_pd }}">
                                @error('nama_pd')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="ttl" class="col-sm-3 col-form-label">Tempat, Tanggal Lahir</label>
                                :<input type="text" name="ttl" id="ttl" class="form-control col-sm-8" value="{{ $calon_siswa_smp->ttl }}">
                                @error('ttl')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                ...
                                :<select name="jenis_kelamin" id="jenis_kelamin" class="form-control col-sm-8">
                                        <option selected disabled>Pilih salah satu</option>
                                        <option value="Laki-laki" @if ($calon_siswa_smp->jenis_kelamin  == "Laki-laki")selected @endif>Laki-laki</option>
                                        <option value="Perempuan" @if ($calon_siswa_smp->jenis_kelamin  == "Perempuan")selected @endif>Perempuan</option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group row ml-3">
                                ...
                                :<select name="agama" id="agama" class="form-control col-sm-8">
                                        <option selected disabled>Pilih salah satu</option>
                                        <option value="Islam" @if ($calon_siswa_smp->agama == 'Islam') selected @endif>Islam</option>
                                        <option value="Kristen" @if ($calon_siswa_smp->agama == 'Kristen') selected @endif>Kristen</option>
                                        <option value="Katholik" @if ($calon_siswa_smp->agama == 'Katholik') selected @endif>Katholik</option>
                                        <option value="Hindu" @if ($calon_siswa_smp->agama == 'Hindu') selected @endif>Hindu</option>
                                        <option value="Buddha" @if ($calon_siswa_smp->agama == 'Buddha') selected @endif>Buddha</option>
                                        <option value="Konghucu" @if ($calon_siswa_smp->agama == 'Konghucu') selected @endif>Konghucu</option>
                                </select>
                                @error('agama')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group row ml-3">
                                <label for="anak_ke" class="col-sm-3 col-form-label">Anak Ke</label>
                                :<input type="number" name="anak_ke" id="anak_ke" class="form-control col-sm-8" value="{{ $calon_siswa_smp->anak_ke }}">
                                @error('anak_ke')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="status_dalam_keluarga" class="col-sm-3 col-form-label">Status dalam Keluarga</label>
                                :<input type="text" name="status_dalam_keluarga" id="status_dalam_keluarga" class="form-control col-sm-8" value="{{ $calon_siswa_smp->status_dalam_keluarga }}">
                                @error('status_dalam_keluarga')
                                    <div class="text-dangermt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="alamat_pd" class="col-sm-3 col-form-label">Alamat</label>
                                :<textarea rows="3" name="alamat_pd" id="alamat_pd" class="form-control col-sm-8" value="{{ $calon_siswa_smp->alamat_pd }}"></textarea>
                                @error('alamat_pd')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="telp_pd" class="col-sm-3 col-form-label">Telp/HP</label>
                                :<input type="number" name="telp_pd" id="telp_pd" class="form-control col-sm-8" value="{{ $calon_siswa_smp->telp_pd }}">
                                @error('telp_pd')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>Sekolah Asal</h4></b>
                            <div class="form-group row ml-3">
                                <label for="nama_asal_sekolah" class="col-sm-3 col-form-label">Nama Sekolah</label>
                                :<input type="text" name="nama_asal_sekolah" id="nama_asal_sekolah" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nama_asal_sekolah }}">
                                @error('nama_asal_sekolah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="alamat_asal_sekolah" class="col-sm-3 col-form-label">Alamat Sekolah</label>
                                :<textarea rows="3" name="alamat_asal_sekolah" id="alamat_asal_sekolah" class="form-control col-sm-8" value="{{ $calon_siswa_smp->alamat_asal_sekolah }}"></textarea>
                                @error('alamat_asal_sekolah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>Ijazah SD/MI/Paket A</h4></b>
                            <div class="form-group row ml-3">
                                <label for="tahun_ijazah" class="col-sm-3 col-form-label">Tahun</label>
                                :<input type="number" name="tahun_ijazah" id="tahun_ijazah" class="form-control col-sm-8" value="{{ $calon_siswa_smp->tahun_ijazah }}">
                                @error('tahun_ijazah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="nomor_ijazah" class="col-sm-3 col-form-label">Nomor Ijazah</label>
                                :<input type="text" name="nomor_ijazah" id="nomor_ijazah" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nomor_ijazah }}">
                                @error('nomor_ijazah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>SKHUN SD/MI/Paket A</h4></b>
                            <div class="form-group row ml-3">
                                <label for="tahun_skhun" class="col-sm-3 col-form-label">Tahun</label>
                                :<input type="number" name="tahun_skhun" id="tahun_skhun" class="form-control col-sm-8" value="{{ $calon_siswa_smp->tahun_skhun }}">
                                @error('tahun_skhun')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="nomor_skhun" class="col-sm-3 col-form-label">Nomor SKHUN</label>
                                :<input type="text" name="nomor_skhun" id="nomor_skhun" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nomor_ijazah }}">
                                @error('nomor_skhun')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>UN SD/MI/Paket A</h4></b>
                            <div class="form-group row ml-3">
                                <label for="nomor_peserta_un" class="col-sm-3 col-form-label">Nomor Peserta</label>
                                :<input type="text" name="nomor_peserta_un" id="nomor_peserta_un" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nomor_ijazah }}">
                                @error('nomor_peserta_un')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>Orangtua</h4></b>
                            <div class="form-group row ml-3">
                                <label for="nama_ayah" class="col-sm-3 col-form-label">Nama Ayah</label>
                                :<input type="text" name="nama_ayah" id="nama_ayah" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nama_ayah }}">
                                @error('nama_ayah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="nama_ibu" class="col-sm-3 col-form-label">Nama Ibu</label>
                                :<input type="text" name="nama_ibu" id="nama_ibu" class="form-control col-sm-8" value="{{ $calon_siswa_smp->nama_ibu }}">
                                @error('nama_ibu')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="alamat_ortu" class="col-sm-3 col-form-label">Alamat</label>
                                :<textarea rows="3" name="alamat_ortu" id="alamat_ortu" class="form-control col-sm-8" value="{{ $calon_siswa_smp->alamat_ortu }}"></textarea>
                                @error('alamat_ortu')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="telp_ortu" class="col-sm-3 col-form-label">Telp/HP</label>
                                :<input type="number" name="telp_ortu" id="telp_ortu" class="form-control col-sm-8" value="{{ $calon_siswa_smp->telp_ortu }}">
                                @error('telp_ortu')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="pekerjaan_ayah" class="col-sm-3 col-form-label">Pekerjaan Ayah</label>
                                :<input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" class="form-control col-sm-8" value="{{ $calon_siswa_smp->pekerjaan_ayah }}">
                                @error('pekerjaan_ayah')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="pekerjaan_ibu" class="col-sm-3 col-form-label">Pekerjaan Ibu</label>
                                :<input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" class="form-control col-sm-8" value="{{ $calon_siswa_smp->pekerjaan_ibu }}">
                                @error('pekerjaan_ibu')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>Wali</h4></b>
                            <div class="form-group row ml-3">
                                <label for="nama_wali" class="col-sm-3 col-form-label">Nama Wali</label>
                                :<input type="text" name="nama_wali" id="nama_wali" class="form-control col-sm-8"value="{{ $calon_siswa_smp->nama_wali }}">
                                @error('nama_wali')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="alamat_wali" class="col-sm-3 col-form-label">Alamat</label>
                                :<textarea rows="3" name="alamat_wali" id="alamat_wali" class="form-control col-sm-8"value="{{ $calon_siswa_smp->alamat_wali }}"></textarea>
                                @error('alamat_wali')
                                    <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group row ml-3">
                                <label for="pekerjaan_wali" class="col-sm-3 col-form-label">Pekerjaan</label>
                                :<input type="text" name="pekerjaan_wali" id="pekerjaan_wali" class="form-control col-sm-8"value="{{ $calon_siswa_smp->pekerjaan_wali }}">
                                @error('pekerjaan_wali')
                                    <div class="text-dangermt-2 col-sm-3">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 ml-3"><b><h4>Dokumen</h4></b>
                            ...
                            @if ($calon_siswa_smp->foto_pd)
                                <img class="d-flex mx-auto mb-3" src="{{ asset("dokumen/smp/" . $calon_siswa_smp->foto_pd) }}" alt="{{ $calon_siswa_smp->foto_pd }}">
                            @endif
                            <div class="form-group row ml-3">
                                <label for="scan_ijazah" class="col-sm-3 col-form-label">Scan Ijazah</label>
                                :<input type="file" name="scan_ijazah" id="scan_ijazah" class="col-sm-8">
                            ...
                            @if ($calon_siswa_smp->scan_ijazah)
                                <img class="d-flex mx-auto mb-3" src="{{ asset("dokumen/smp/" . $calon_siswa_smp->scan_ijazah) }}" alt="{{ $calon_siswa_smp->scan_ijazah }}">
                            @endif
                            <div class="form-group row ml-3">
                                <label for="scan_skhun" class="col-sm-3 col-form-label">Scan SKHUN</label>
                                :<input type="file" name="scan_skhun" id="scan_skhun" class="col-sm-8">
                            ...
                            @if ($calon_siswa_smp->scan_skhun)
                                <img class="d-flex mx-auto mb-3" src="{{ asset("dokumen/smp/" . $calon_siswa_smp->scan_skhun) }}" alt="{{ $calon_siswa_smp->scan_skhun }}">
                            @endif
                        </div>

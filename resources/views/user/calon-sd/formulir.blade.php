                ...
                @if (Auth::user()->is_data_verified == 0)
                    <div class="card-body mt-3">
                        <div class="text-danger">
                            <h6>PerhatiKan! Silahkan Anda isi formulir berikut sesuai dengan dengan data yang ada</h6>
                        </div>
                        <br>
                        <form action="/calon/sd/store/{{ $user->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 ml-3"><b><h4>IDENTITAS SISWA</h4></b>
                                
                                <div class="form-group row ml-3">
                                    <label for="nama_pd" class="col-sm-3 col-form-label">Nama Lengkap</label>
                                        :<input type="text" name="nama_pd" id="nama_pd" class="form-control col-sm-8" value="{{ old('nama_pd') }}" placeholder="sesuai Akta Kelahiran">
                                    @error('nama_pd')
                                ...
                                <div class="form-group row ml-3">
                                    ...
                                    :<input placeholder="Sesuai Kartu Keluarga" type="number" name="nik" id="nik" class="form-control col-sm-8" value="{{ old('nik') }}">
                                    @error('nik')
                                        <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group row ml-3">
                                    ...
                                    :<input type="text" name="t" id="t" class="form-control col-sm-4 mr-3" value="{{ old('t') }}"><input type="date" name="tl" id="tl" class="form-control col-sm-3 ml-3" value="{{ old('tl') }}">
                                    @error('ttl')
                                        <div class="text-danger mt-2 col-sm-3">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 ml-3"><b><h4>Dokumen</h4></b>
                                ...
                                <div class="form-group row ml-3">
                                    <label for="scan_ijazah" class="col-sm-3 col-form-label">Scan Ijazah PAUD/TK (jika ada)</label>

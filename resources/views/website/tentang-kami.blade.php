        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="text-container">
                    ...
                    <p></p>
                    <p class="testimonial-text text-justify">"Kami terus berusaha memberikan dan mengembangkan sistem pendidikan yang sebaik mungkin berbasis media digital serta berwawasan internasional untuk memberikan yang terbaik."</p>
                </div>
            </div>
            <div class="col-lg-7">
    ...
    <div class="akademik row">
        ...
        <div class="area-2 col-6">    
            ...
            <div class="akademik-container" id="akademikTK">
                <a href="#" class="text-decoration-none"><h2>TK ANANDA UT</h2></a>
                <div class="item">
                    <div id="headingOneTK">
                    ...
                    <div id="collapseOneTK" class="collapse show" aria-labelledby="headingOneTK" data-parent="#akademikTK" style="">
                        <div class="akademik-body">
                            Menjadi tempat bermain dan belajar yang menyenangkan, aman dan nyaman bagi anak dalam mengembangkan seluruh potensinya.
                        </div>
                    </div>
                </div> 
                ...
                <div class="item">
                    <div id="headingTwoTK">
                        <span class="collapsed" data-toggle="collapse" data-target="#collapseTwoTK" aria-expanded="false" aria-controls="collapseTwoTK" role="button">
                            <span class="circle-numbering">2</span><span class="akademik-title">Fasilitas yang Kami Berikan</span>
                        </span>
                    </div>
    ...
    <div class="akademik row">
        ...
        <div class="area-2 col-6">
            ...
            <div class="akademik-container" id="akademikSD">
                <a href="https://www.sddharmakarya.com/" class="text-decoration-none"><h2>SD DHARMA KARYA UT</h2></a>
                <div class="item">
                    <div id="headingOneSD">
    ...
    <div class="akademik row">
        ...
        <div class="area-2 col-6">
            ...
            <div class="akademik-container" id="akademikSMP">
                <a href="http://www.dharmakaryaut.com/" class="text-decoration-none"><h2>SMP DHARMA KARYA UT</h2></a>
                <div class="item">
    ...
    <div class="akademik row">
        ...
        <div class="area-2">
            ...
            <div class="akademik-container" id="akademikSMA">
                <a href="https://smadharmakaryaut.sch.id/" class="text-decoration-none"><h2>SMA DHARMA KARYA UT</h2></a>
                <div class="item">
